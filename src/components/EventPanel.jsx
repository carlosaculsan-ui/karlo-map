    ...
    >
      ...
      >
        ...
        <div className="flex shrink-0 items-center justify-between px-4 pt-4 pb-3 border-b border-white/5">
          ...
          <button
            onClick={onClose}
            className="flex h-6 w-6 items-center justify-center rounded-full bg-white/5 text-white/40 transition-colors hover:bg-white/10 hover:text-white/80 focus:outline-none"
